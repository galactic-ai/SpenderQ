...
if __name__=="__main__": 
    # edr 
    #train_spenderq('qso.edr.hiz', 'DESI.edr.qso_highz', 2.1, 3.5, similarity=True, consistency=True, debug=False) # first spenderq training with sim and con loss
    ...
    #for ibatch in range(25,85): 
    #    absorbers('MgII', 'qso.edr.hiz.sa1p5sb1p5.i3', 'DESI.edr.qso_highz', ibatch, n_model=5, debug=False)
    #for ibatch in range(26, 85): 
    #    absorbers('CIV', 'qso.edr.hiz.sa1p5sb1p5.i3', 'DESI.edr.qso_highz', ibatch, n_model=5, debug=False)
    absorbers('CIV', 'qso.edr.hiz.sa1p5sb1p5.i3', 'DESI.edr.qso_highz', 67, n_model=5, debug=True)
